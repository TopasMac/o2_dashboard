 ...
 */
final class Version20250906085601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_email_notifications DROP category, CHANGE subject subject VARCHAR(255) NOT NULL, CHANGE recipient_email recipient_email VARCHAR(255) NOT NULL, CHANGE received_at received_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_email_notifications ADD category VARCHAR(255) DEFAULT NULL, CHANGE subject subject VARCHAR(255) DEFAULT NULL, CHANGE recipient_email recipient_email VARCHAR(255) DEFAULT NULL, CHANGE received_at received_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
