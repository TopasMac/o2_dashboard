 ...
 */
final class Version20250826232727 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_balance_ledger ADD CONSTRAINT FK_3584AFCA2E5A6081 FOREIGN KEY (o2_transaction_id) REFERENCES o2transactions (id) ON UPDATE NO ACTION ON DELETE SET NULL
        SQL);
        $this->addSql(<<<'SQL'
