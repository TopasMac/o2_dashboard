 ...
 */
final class Version20251101035614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_inventory_session ADD sent_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD signed_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', CHANGE status status VARCHAR(32) DEFAULT 'collecting' NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_inventory_session DROP sent_at, DROP signed_at, CHANGE status status VARCHAR(32) DEFAULT 'draft' NOT NULL
        SQL);
    }
}
