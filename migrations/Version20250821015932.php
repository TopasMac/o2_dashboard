 ...
 */
final class Version20250821015932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE o2transactions ADD private TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE o2transactions DROP private
        SQL);
    }
}
