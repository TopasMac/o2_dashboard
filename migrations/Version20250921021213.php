 ...
 */
final class Version20250921021213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE hk_cleanings (id INT AUTO_INCREMENT NOT NULL, unit_id INT NOT NULL, city VARCHAR(64) NOT NULL, booking_id INT DEFAULT NULL, reservation_code VARCHAR(64) DEFAULT NULL, checkout_date DATE NOT NULL, cleaning_type VARCHAR(16) NOT NULL, expected_fee NUMERIC(10, 2) DEFAULT '0.00' NOT NULL, o2_collected_fee NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(16) NOT NULL, hk_worker_id INT DEFAULT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_5738ED61F8BD700D (unit_id), UNIQUE INDEX uniq_unit_checkout_type (unit_id, checkout_date, cleaning_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hk_cleanings ADD CONSTRAINT FK_5738ED61F8BD700D FOREIGN KEY (unit_id) REFERENCES unit (id) ON DELETE RESTRICT
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE hk_cleanings DROP FOREIGN KEY FK_5738ED61F8BD700D
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE hk_cleanings
        SQL);
        $this->addSql(<<<'SQL'
