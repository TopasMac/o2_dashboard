 ...
 */
final class Version20251015014548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE airbnb_payout_email_import (id INT AUTO_INCREMENT NOT NULL, received_at DATETIME NOT NULL, from_email VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, body_html LONGTEXT DEFAULT NULL, body_text LONGTEXT DEFAULT NULL, message_id VARCHAR(255) NOT NULL, parse_status VARCHAR(32) NOT NULL, parse_error LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_3ACA9FE537A1329 (message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            DROP TABLE airbnb_payout_email_import
        SQL);
        $this->addSql(<<<'SQL'
