 ...
 */
final class Version20251013003051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE employee_financial_ledger ADD area VARCHAR(80) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE employee_financial_ledger DROP area
        SQL);
        $this->addSql(<<<'SQL'
