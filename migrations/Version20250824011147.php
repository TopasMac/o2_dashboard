 ...
 */
final class Version20250824011147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_balance_ledger ADD date DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_balance_ledger DROP date
        SQL);
    }
}
