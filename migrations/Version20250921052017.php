 ...
 */
final class Version20250921052017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hk_cleanings ADD cleaning_cost NUMERIC(10, 2) DEFAULT NULL, DROP expected_fee
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hk_cleanings ADD expected_fee NUMERIC(10, 2) DEFAULT '0.00' NOT NULL, DROP cleaning_cost
        SQL);
        $this->addSql(<<<'SQL'
