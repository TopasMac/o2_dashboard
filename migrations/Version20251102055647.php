 ...
 */
final class Version20251102055647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings ADD last_updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD last_updated_via VARCHAR(20) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings DROP last_updated_at, DROP last_updated_via
        SQL);
        $this->addSql(<<<'SQL'
