 ...
 */
final class Version20251025070042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_media CHANGE is_published is_published TINYINT(1) DEFAULT 0 NOT NULL, CHANGE is_cover is_cover TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_media CHANGE is_published is_published TINYINT(1) NOT NULL, CHANGE is_cover is_cover TINYINT(1) NOT NULL
        SQL);
    }
}
