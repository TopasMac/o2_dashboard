 ...
 */
final class Version20250903055759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings ADD is_paid TINYINT(1) DEFAULT 0 NOT NULL, ADD payment_note LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings DROP is_paid, DROP payment_note
        SQL);
        $this->addSql(<<<'SQL'
