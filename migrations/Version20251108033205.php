 ...
 */
final class Version20251108033205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout ADD payout_details VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout DROP payout_details
        SQL);
        $this->addSql(<<<'SQL'
