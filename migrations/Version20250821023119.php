 ...
 */
final class Version20250821023119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings CHANGE booking_date booking_date DATE NOT NULL COMMENT '(DC2Type:date_immutable)', CHANGE check_in check_in DATE NOT NULL COMMENT '(DC2Type:date_immutable)', CHANGE check_out check_out DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings CHANGE booking_date booking_date DATE NOT NULL, CHANGE check_in check_in DATE NOT NULL, CHANGE check_out check_out DATE NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
