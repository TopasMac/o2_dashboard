 ...
 */
final class Version20251015050338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit ADD airbnb_pay_route VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit DROP airbnb_pay_route
        SQL);
        $this->addSql(<<<'SQL'
