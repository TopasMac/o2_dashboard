 ...
 */
final class Version20251108082616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE accountant_entry ADD recon_checked_at DATETIME DEFAULT NULL, ADD recon_checked_by INT DEFAULT NULL, ADD recon_payout_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout ADD recon_checked_at DATETIME DEFAULT NULL, ADD recon_checked_by INT DEFAULT NULL, ADD recon_accountant_entry_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE accountant_entry DROP recon_checked_at, DROP recon_checked_by, DROP recon_payout_id
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout DROP recon_checked_at, DROP recon_checked_by, DROP recon_accountant_entry_id
        SQL);
        $this->addSql(<<<'SQL'
