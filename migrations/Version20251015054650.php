 ...
 */
final class Version20251015054650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE airbnb_payout_recon_state (id INT AUTO_INCREMENT NOT NULL, batch_id INT DEFAULT NULL, reservation_code VARCHAR(32) NOT NULL, is_paid TINYINT(1) DEFAULT 0 NOT NULL, paid_at DATETIME DEFAULT NULL, note LONGTEXT DEFAULT NULL, set_by_user_id INT DEFAULT NULL, INDEX IDX_CE7D3368F39EBE7A (batch_id), UNIQUE INDEX uq_recon_batch_code (batch_id, reservation_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout_recon_state ADD CONSTRAINT FK_CE7D3368F39EBE7A FOREIGN KEY (batch_id) REFERENCES airbnb_payout_batch (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE airbnb_payout_recon_state DROP FOREIGN KEY FK_CE7D3368F39EBE7A
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE airbnb_payout_recon_state
        SQL);
        $this->addSql(<<<'SQL'
