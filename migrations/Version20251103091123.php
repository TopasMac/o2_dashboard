 ...
 */
final class Version20251103091123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings ADD ical_ack_signature VARCHAR(128) DEFAULT NULL, ADD ical_ack_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD ical_ack_user_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings DROP ical_ack_signature, DROP ical_ack_at, DROP ical_ack_user_id
        SQL);
        $this->addSql(<<<'SQL'
