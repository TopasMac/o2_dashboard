 ...
 */
final class Version20250925084824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, employee_code VARCHAR(20) NOT NULL, name VARCHAR(100) NOT NULL, short_name VARCHAR(50) DEFAULT NULL, phone VARCHAR(30) DEFAULT NULL, email VARCHAR(120) DEFAULT NULL, division VARCHAR(30) NOT NULL, area VARCHAR(30) NOT NULL, city VARCHAR(50) NOT NULL, date_started DATE NOT NULL, date_ended DATE DEFAULT NULL, initial_salary NUMERIC(10, 2) NOT NULL, current_salary NUMERIC(10, 2) NOT NULL, status VARCHAR(20) DEFAULT 'Active' NOT NULL, notes LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_5D9F75A1C2CC7ADF (employee_code), UNIQUE INDEX UNIQ_5D9F75A1E7927C74 (email), UNIQUE INDEX UNIQ_5D9F75A1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
