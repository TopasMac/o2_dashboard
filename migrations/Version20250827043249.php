 ...
 */
final class Version20250827043249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document ADD CONSTRAINT FK_AD5760E4A7B913DD FOREIGN KEY (ledger_id) REFERENCES unit_balance_ledger (id) ON DELETE CASCADE
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document ADD CONSTRAINT FK_AD5760E4A7B913DD FOREIGN KEY (ledger_id) REFERENCES unit_balance_ledger (id) ON UPDATE NO ACTION ON DELETE SET NULL
        SQL);
    }
}
