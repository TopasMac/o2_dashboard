 ...
 */
final class Version20250903065045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings DROP payment_note
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE all_bookings ADD payment_note LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
