 ...
 */
final class Version20250823101134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE owner_report_cycle CHANGE `year_month` report_month VARCHAR(7) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE owner_report_cycle CHANGE report_month `year_month` VARCHAR(7) NOT NULL
        SQL);
    }
}
