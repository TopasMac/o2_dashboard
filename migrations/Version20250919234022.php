 ...
 */
final class Version20250919234022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document ADD o2_transaction_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document ADD CONSTRAINT FK_AD5760E42E5A6081 FOREIGN KEY (o2_transaction_id) REFERENCES o2transactions (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_AD5760E42E5A6081 ON unit_document (o2_transaction_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document DROP FOREIGN KEY FK_AD5760E42E5A6081
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_AD5760E42E5A6081 ON unit_document
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document DROP o2_transaction_id
        SQL);
    }
}
