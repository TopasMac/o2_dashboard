 ...
 */
final class Version20250905072247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE review_action (id INT AUTO_INCREMENT NOT NULL, reservation_id INT NOT NULL, status VARCHAR(16) NOT NULL, skip_reason VARCHAR(16) DEFAULT NULL, expired_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', acted_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', checkout_date DATE DEFAULT NULL, source VARCHAR(50) DEFAULT NULL, unit_name VARCHAR(180) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', UNIQUE INDEX uniq_reservation (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
