 ...
 */
final class Version20250824001528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            UPDATE o2transactions SET created_at = DATE(created_at)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE o2transactions CHANGE created_at created_at DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
