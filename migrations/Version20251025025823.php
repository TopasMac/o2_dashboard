 ...
 */
final class Version20251025025823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_media ADD caption_es VARCHAR(255) DEFAULT NULL, ADD seo_description_es LONGTEXT DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_media DROP caption_es, DROP seo_description_es
        SQL);
    }
}
