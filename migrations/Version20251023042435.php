 ...
 */
final class Version20251023042435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit ADD pax INT DEFAULT NULL, ADD baths INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit DROP pax, DROP baths
        SQL);
        $this->addSql(<<<'SQL'
