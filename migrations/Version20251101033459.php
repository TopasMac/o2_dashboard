 ...
 */
final class Version20251101033459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_inventory_session ADD inv_issued_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD photo_issued_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)'
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_inventory_session DROP inv_issued_at, DROP photo_issued_at
        SQL);
    }
}
