 ...
 */
final class Version20251102040550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ical_events ADD reservation_url VARCHAR(1024) DEFAULT NULL, ADD reservation_code VARCHAR(32) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ical_events DROP reservation_url, DROP reservation_code
        SQL);
        $this->addSql(<<<'SQL'
