 ...
 */
final class Version20250920000441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document CHANGE unit_id unit_id INT DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_document CHANGE unit_id unit_id INT NOT NULL
        SQL);
    }
}
