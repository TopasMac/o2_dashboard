 ...
 */
final class Version20251012234515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_efl_period_start ON employee_financial_ledger
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE employee_financial_ledger ADD code VARCHAR(16) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_BA30C64A77153098 ON employee_financial_ledger (code)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_BA30C64A77153098 ON employee_financial_ledger
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE employee_financial_ledger DROP code
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX idx_efl_period_start ON employee_financial_ledger (period_start)
        SQL);
        $this->addSql(<<<'SQL'
