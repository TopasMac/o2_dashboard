 ...
 */
final class Version20250907072457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE alert_dismissal (id INT AUTO_INCREMENT NOT NULL, token VARCHAR(255) NOT NULL, dismissed_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', dismissed_by_email VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_734B0FA25F37A13B (token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
