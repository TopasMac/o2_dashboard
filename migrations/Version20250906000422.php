 ...
 */
final class Version20250906000422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE airbnb_email_notifications (id INT AUTO_INCREMENT NOT NULL, subject VARCHAR(255) NOT NULL, guest_name VARCHAR(255) DEFAULT NULL, unit_name VARCHAR(255) DEFAULT NULL, airbnb_link VARCHAR(512) DEFAULT NULL, recipient_email VARCHAR(255) NOT NULL, received_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', message_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FA8EDDC1537A1329 (message_id), INDEX idx_airbnb_notif_recipient (recipient_email), INDEX idx_airbnb_notif_received_at (received_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            DROP TABLE airbnb_email_notifications
        SQL);
        $this->addSql(<<<'SQL'
