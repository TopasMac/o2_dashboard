 ...
 */
final class Version20251102231937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit ADD private_ical_enabled TINYINT(1) DEFAULT 0 NOT NULL, ADD ical_export_token VARCHAR(64) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit DROP private_ical_enabled, DROP ical_export_token
        SQL);
        $this->addSql(<<<'SQL'
