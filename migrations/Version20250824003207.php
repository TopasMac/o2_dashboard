 ...
 */
final class Version20250824003207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_balance_ledger DROP currency
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_balance_ledger ADD currency VARCHAR(3) DEFAULT 'MXN' NOT NULL
        SQL);
    }
}
