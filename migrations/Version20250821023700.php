 ...
 */
final class Version20250821023700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions CHANGE date date DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE meter_reading CHANGE reading_date reading_date DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions CHANGE date date DATE NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE meter_reading CHANGE reading_date reading_date DATE NOT NULL
        SQL);
    }
}
