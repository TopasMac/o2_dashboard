 ...
 */
final class Version20250821023826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE private_reservation CHANGE booking_date booking_date DATE NOT NULL COMMENT '(DC2Type:date_immutable)', CHANGE check_in check_in DATE NOT NULL COMMENT '(DC2Type:date_immutable)', CHANGE check_out check_out DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_transactions CHANGE date date DATE NOT NULL COMMENT '(DC2Type:date_immutable)'
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE private_reservation CHANGE booking_date booking_date DATETIME NOT NULL, CHANGE check_in check_in DATE NOT NULL, CHANGE check_out check_out DATE NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE unit_transactions CHANGE date date DATE NOT NULL
        SQL);
    }
}
