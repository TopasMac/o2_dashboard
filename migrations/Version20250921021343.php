 ...
 */
final class Version20250921021343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions ADD hk_cleaning_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions ADD CONSTRAINT FK_167851062C334BCF FOREIGN KEY (hk_cleaning_id) REFERENCES hk_cleanings (id) ON DELETE SET NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_167851062C334BCF ON hktransactions (hk_cleaning_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions DROP FOREIGN KEY FK_167851062C334BCF
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_167851062C334BCF ON hktransactions
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hktransactions DROP hk_cleaning_id
        SQL);
        $this->addSql(<<<'SQL'
