...
class AirbnbImportController extends AbstractController
{
    ...
    public function import(Request $request, EntityManagerInterface $em, BookingProcessingService $bookingProcessor, \App\Service\BookingAggregatorService $bookingAggregator, AirbnbEmailPayoutCorrector $payoutCorrector): JsonResponse
    {
        ...
        try {
            $financials = $payoutCorrector->parse($body);
